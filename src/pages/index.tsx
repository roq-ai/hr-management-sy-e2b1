  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management System: Streamlining Employee Data, Payrolls, Time Tracking, and Performance Evaluations. A Unified Platform for Employees, Payroll Office, and Teamleads to Manage and Review All Essential HR Information."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management System: Streamlining Employee Data, Payrolls, Time Tracking, and Performance Evaluations. A Unified Platform for Employees, Payroll Office, and Teamleads to Manage and Review All Essential HR Information.`}
            </Text>
            <Box
