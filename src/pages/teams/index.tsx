...
export function TeamListPage(props: TeamListPageProps) {
    ...
    async () =>
      getTeams({
        ...
        searchTermKeys: [
          ...
          'image.contains',
          'name.contains',
          'performance_evaluation_frequency.contains',
          'team_objective.contains',
          'team_vision.contains',
        ],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'team_lead_id', header: 'team_lead_id', accessorKey: 'team_lead_id' },
    {
      id: 'performance_evaluation_frequency',
      header: 'Performance Evaluation Frequency',
      accessorKey: 'performance_evaluation_frequency',
    },
    { id: 'team_size', header: 'team_size', accessorKey: 'team_size' },
    { id: 'team_budget', header: 'Team Budget', accessorKey: 'team_budget' },
    { id: 'team_performance_score', header: 'Team Performance Score', accessorKey: 'team_performance_score' },
    { id: 'team_objective', header: 'Team Objective', accessorKey: 'team_objective' },
    { id: 'team_vision', header: 'Team Vision', accessorKey: 'team_vision' },
    { id: 'team_morale_score', header: 'Team Morale Score', accessorKey: 'team_morale_score' },
    { id: 'team_productivity_score', header: 'Team Productivity Score', accessorKey: 'team_productivity_score' },
    { id: 'team_vacation_quota', header: 'team_vacation_quota', accessorKey: 'team_vacation_quota' },
